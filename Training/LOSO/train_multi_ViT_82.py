...
if __name__ == "__main__":
    ...
    Images = [
        "Chunk/Balabit_chunks_XY_black_white/event300","Chunk/Balabit_chunks_XY_black_white_cdf/training/event300",
        "Chunk/Balabit_chunks_XY_black_white/event120","Chunk/Balabit_chunks_XY_black_white_cdf/training/event120"
    ]
