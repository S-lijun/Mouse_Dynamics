...
def compute_dvt_rp(seq, percentile=95):
    ...
    velocity_stripe = np.tile(v_norm[None, :], (T, 1))
...
def draw_dvt_image(seq, save_path, percentile, chunk_size):

    img = compute_dvt_rp(seq, percentile)
        ...
        for file in sorted(os.listdir(user_dir)):
            ...
            for chunk_size in sizes:
                ...
                for i in range(n_chunks):
                    ...
                    draw_dvt_image(seq, save_path, percentile, chunk_size)
