...
def compute_arp_vxvy(seq, percentile=95):
...
def draw_arp_vxvy(seq, save_path, percentile, chunk_size):

    img = compute_arp_vxvy(seq, percentile)
        ...
        for file in sorted(os.listdir(user_dir)):
            ...
            for chunk_size in sizes:
                ...
                for i in range(n_chunks):
                    ...
                    draw_arp_vxvy(seq, save_path, percentile, chunk_size)
