...
def compute_srp_velocity(seq, percentile=95):
...
def draw_srp_velocity(seq, save_path, percentile, chunk_size):

    img = compute_srp_velocity(seq, percentile)
        ...
        for file in sorted(os.listdir(user_dir)):
            ...
            for chunk_size in sizes:
                ...
                for i in range(n_chunks):
                    ...
                    draw_srp_velocity(seq, save_path, percentile, chunk_size)
...
def main():
    ...
    print("\nSRP Velocity generation finished.")
