...
Usage:
  python XYPlot_chunk_per_user_vxvy.py --dataset chaoshen \\
    --data_root Data/ChaoShen/training_files \\
    --velocity_dist ChaoShen_vxvy_distribution_raw.npz \\
    --out_dir Images/ChaoShen/XYPlot_chunk_per_user_vxvy
"""
...
# ============================================================
# Draw: per-user screen coords + vx/vy stroke (R=0, G=vx, B=vy)
# ============================================================
...
def main():
    ...
    parser.add_argument(
        "--velocity_dist",
        required=True,
        help="npz with vx/vy arrays (e.g. ChaoShen_vxvy_distribution_raw.npz).",
    )
