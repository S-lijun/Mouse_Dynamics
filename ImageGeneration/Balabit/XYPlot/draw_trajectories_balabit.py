...
# -*- coding: utf-8 -*-
"""
Pure Chunking XYPlot Baseline (Unified Style)
---------------------------------------------
- Pure spatial geometry
- No timing, no velocity, no encoding
- White background, black trajectory
- Pixel-mass normalized across chunk sizes
- CLI + print style aligned with velocity script
"""
...
def main():
    ...
    print("\n[Step] Generating Baseline XYPlot Images")
    process_dataset(data_root, out_dir, sorted(set(args.sizes)))

    print("\n[Done] Baseline Generation Complete.")
