# -*- coding: utf-8 -*-
"""
SRP — Time Difference Hybrid Encoding (DFL Version, Protocol-Safe)
-------------------------------------------------------------------
R Channel: Position Recurrence (Distance Matrix)
G/B Channel: Pairwise |Δt| Matrix (Global Runtime CDF)

- Uses RAW DFL training time-difference distribution
...
def main():
    ...
    print("\n[Step] Generating DFL SRP Time-Difference Images")
    process_dataset(data_root, out_dir, sorted(set(args.sizes)), args.p_percentile)

    print("\n[Done] DFL SRP Time-Difference Generation Complete.")
