# -*- coding: utf-8 -*-
"""
SRP — Velocity Hybrid Encoding (DFL Version, Protocol-Safe)
------------------------------------------------------------
- R Channel: Position Recurrence Matrix
- G/B Channels: Velocity Vertical Stripes
- Uses RAW DFL training velocity distribution
...
def main():
    ...
    parser.add_argument("--out_dir", type=str,
                        default="Images/DFL/SRP_velocity")
    ...
    print("\n[Step] Generating DFL SRP Velocity Images")
    process_dataset(data_root, out_dir, sorted(set(args.sizes)), args.p_percentile)

    print("\n[Done] DFL SRP Velocity Generation Complete.")
